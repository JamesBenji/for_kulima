...
import { approveAccessRequest, isMinAdmin, reGrantDistrictAdminAccess, revokeDistrictAdminAccess } from "@/lib/min_admin_funcs/functions";
  ...
  try {
   ...
   const supabase = createClient()
    ...
    if (mayBeAdminEmail) {
      ...
      if(target_mail){
        const result = await reGrantDistrictAdminAccess(target_mail, supabase)
